...
import 'package:amazon_clone_tutorial/features/search/services/search_services_user.dart'; /* Novo */
import 'package:amazon_clone_tutorial/features/search/widget/searched_user.dart'; /* Novo */
...
class _SearchScreenUserState extends State<SearchScreenUser> {
  List<User>? users;
  final SearchServicesUser searchServices = SearchServicesUser();
