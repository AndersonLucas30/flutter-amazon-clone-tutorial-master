...
class CategoryDealsScreen extends StatefulWidget {
  ...
  final String categoria_user;
  const CategoryDealsScreen({
    Key? key,
    required this.categoria_user,
  }) : super(key: key);
...
class _CategoryDealsScreenState extends State<CategoryDealsScreen> {
  ...
  fetchCategoryProducts() async {
    userList = await homeServices.fetchCategoryProducts(
      context: context,
      categoria_user: widget.categoria_user,
    );
    setState(() {});
  }
          ...
          : Column(
              children: [
                Container(
                  ...
                  child: Text(
                    'Keep shopping for ${widget.categoria_user}',
